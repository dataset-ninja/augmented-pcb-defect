...
##################################
PROJECT_NAME: str = "Augmented PCB Defect"
PROJECT_NAME_FULL: str = "Augmented PCB Defect"
...
PREVIEW_IMAGE_ID: int = 8498551
# This should be filled AFTER uploading images to instance, just ID of any image.

GITHUB_URL: str = "https://github.com/dataset-ninja/augmented-pcb-defect"
# URL to GitHub repo on dataset ninja (e.g. "https://github.com/dataset-ninja/some-dataset")

##################################
### * Optional after uploading ###
##################################
DOWNLOAD_ORIGINAL_URL: Optional[Union[str, dict]] = "https://www.dropbox.com/s/h0f39nyotddibsb/VOC_PCB.zip?dl=0"
